...
// grade — saliente bem na ponta do nariz, dentro da altura real do nariz (~0.52m)
box(0.12, 0.18, 0.55, darkMat, NOSE_X - 0.03, 0.36, 0);

// faróis — bloco grande, saliente na ponta do nariz, dentro da altura do nariz
for (const s of [1, -1]) {
    box(0.10, 0.20, 0.40, lampMat, NOSE_X - 0.02, 0.36, s * 0.48);
}

// lanternas — mesma lógica, dentro da altura real da traseira (~0.53m)
for (const s of [1, -1]) {
    box(0.10, 0.18, 0.36, redLampMat, TAIL_X + 0.02, 0.36, s * 0.46);
}
